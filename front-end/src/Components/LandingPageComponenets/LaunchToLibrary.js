    ...
    <div className="launch-to-library container py-5 mt-5">
      <div className="row align-items-center">
        ...
        <div className="col-12 col-md-6 text-center text-md-start">
          <h2 className="mb-3 fw-bold">📚 Launch to Library</h2>
          <p className="mb-4">
          ...
          <ul className="list-unstyled">
            <li>Store all your generated images securely</li>
            <li>Access and manage your past creations</li>
            <li>Retrieve, edit, and republish when needed</li>
          </ul>
